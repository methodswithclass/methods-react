...
var getItem = function (name) {
	...
	if (resolveName(name)) {
		...
		return (
			...
			<div className="relative width-300 height-50 hcenter black-back white rounded10 margin-v-100 pointer" onClick={goto(name.toLowerCase())}>
				<div className="absolute center font-30">
					{name}
				</div>
			</div>
	...
	render() {
		return (
		    ...
		    <div className="absolute width height">
		    	...
		    	<div className="absolute width-100 height-70 left10 z-200" id="menubutton">

					<div className="absolute width-100 height80 center font-40 pointer" onClick={openMenu}>
				...
				<div className="fixed width-600 height top0 left0 z-minus-100" id="menu">
